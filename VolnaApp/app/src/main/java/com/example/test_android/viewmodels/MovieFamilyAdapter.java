...
public class MovieFamilyAdapter extends RecyclerView.Adapter<MovieFamilyAdapter.MovieViewHolder> {
    ...
    private MovieFamilyAdapter.onReachEndListener reachEndListener;
    ...
    public void setOnReachEndListener(MovieFamilyAdapter.onReachEndListener onReachEndListener) {
        this.reachEndListener = onReachEndListener;
    }

    @NonNull
    @Override
    public MovieFamilyAdapter.MovieViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.movie_item, parent, false);
        return new MovieFamilyAdapter.MovieViewHolder(view);
    }

    @SuppressLint("DefaultLocale")
    @Override
    public void onBindViewHolder(@NonNull MovieFamilyAdapter.MovieViewHolder holder, int position) {
